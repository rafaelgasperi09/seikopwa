...
Route::group(array('prefix' => 'maestros'), function() {
    ...
    Route::group(array('prefix' => 'clientes'), function() {
        Route::get('/', array('as' => 'maestros.clientes.index', 'uses' => 'MaestrosController@clientes'));
        Route::post('store/', array('as' => 'maestros.clientes.store', 'uses' => 'MaestrosController@clientes_store'));
    ...
    Route::group(array('prefix' => 'equipos'), function() {
        ...
        Route::post('store/', array('as' => 'maestros.equipos.store', 'uses' => 'MaestrosController@equipos_store'));
    ...
    Route::group(array('prefix' => 'componentes'), function() {
        ...
        Route::post('store/', array('as' => 'maestros.componentes.store', 'uses' => 'MaestrosController@componentes_store'));
