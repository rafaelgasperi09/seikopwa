...
class FormularioMantenimientoPreventivoCounterRC extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($seeciones as $sec){
            ...
            switch ($i){
                case 1:
                    $campos = ['Pérdidas de Aceite','Pernos del techo de protección y del montaje','Montaje del mástil','Desplazador lateral (si hay)','Horquillas y trabas','Respaldo para carga','Almohadillas del compartimiento del operador','Equipamiento de montaje y de la 3a columna',
                ...
                case 2:
                    ...
                    break;
                case 3:
                    $campos = ['Limpiar el montacarga con aire a presión','Limpiar con aire a baja presión todos los paneles eléctricos y el ventilador del controlador','Lubricar los engrasadores',
                ...
                case 6:
                    ...
                    break;
                case 7:
                    $campos = ['Estado del tip del contactor de línea','Estado del tip del contactor de la bomba'];
                    break;
                case 8:
                ...
                case 10:
                    ...
                    'Interruptor de proxímidad','Cable de control (interruptor de proxímidad)','Topes/bumpers'];
                    break;
                case 11:
                    $campos = ['Funcionamiento del calentador','Estado del cableado','Conexiones del cableado'];
                    break;
                case 12:
                    $campos = ['Bocina','Pantalla','Desconexión de emergencia eléctrica','Sistema de servoalimentación','Interruptores de retenedor de la batería (opcional)',
                        'Funcionamiento del sistema de freno','Distancia de parada (a)','Frenado por contramarcha (b)','Aplicar/liberar el freno de estacionamiento','Funcionamiento de inclinación y elevación',
                        ...
                        'Luces de trabajo','Luces estroboscópicas','Interruptores de la barra de entrada','Pedal','Suspensión del piso','Apoyabrazos ajustable (opcional)'];
                    break;
            }
