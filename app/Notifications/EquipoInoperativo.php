...
class EquipoInoperativo extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mail->subject('Se ha registrado un equipo como INOPERATIVO')
            ->greeting('Se ha completado un daily check y se ha marcado su prioridad como "NO USAR ESTE EQUIPO".')
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'title'     => 'Daily Check',
            'color'     => 'info',
            'route'     => route('equipos.detail',array('id'=>$this->formularioRegistro->equipo_id,'tab'=>'dailycheck')),
    ...
    public function toWebPush($notifiable, $notification)
    {
        return (new WebPushMessage)
            ...
            ->body('Se ha registrado un daily check')
