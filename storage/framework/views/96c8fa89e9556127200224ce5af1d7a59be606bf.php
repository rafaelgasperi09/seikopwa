...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="<?php echo e(url('images/AppImages/android/icon-144x144.png')); ?>" alt="image" class="form-image">
            </div>
            ...
            <div class="section mt-1 mb-5">
                <form action="app-pages.html">
                    ...
                    <div class="form-button-group">
                        ...
                        <a href="<?php echo e(url('front/dashboard')); ?>" class="btn btn-primary btn-block btn-lg">Ver Dashboard</a>
                    </div>
...
<?php /**PATH C:\Server\www\seikopwa\resources\views/frontend/login.blade.php ENDPATH**/ ?>