...
return [
    ...
    */
    ...
    'uuid'                  => 'El campo :attribute deb ser un UUID valido.',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'custom' => [
        'password' => [
            'regex'  => '*- La contraseña debe tener al menos 1 minuscula (a-z). *- La contraseña debe tener al menos 1 mayuscula (A-Z). *- La contraseña debe tener al menos 1 caracter especial (#?!@$.%^&*-).',
        ],
    ],
];
