<div id="filtro" class="collapse multi-collapse @if($filtro) in @endif" >
    {{Form::open(array("method" => "GET","action" => "EquiposController@daily_check_list","role" => "form",'class'=>'form-horizontal form-prevent-multiple-submit','autocomplete'=>'off'))}}
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            {{ Form::select('estado',[''=>'Seleccione','C'=>'Cerrado','P'=>'Pendiente'],request('estado'), array("class" => "form-control","id"=>"type"))  }}
                ...
                <div class="col-md-12 col-sm-6 col-12">
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <a href="{{ route('equipos.daily_check_list') }}" type="button" class="btn btn-custom btn-danger  button-prevent-multiple-submit">
