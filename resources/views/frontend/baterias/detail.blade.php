    ...
    <div class="wide-block p-1" id="historial">
        ...
        <div class="tab-content mt-1">
            <div class="tab-pane  {{$tab[0]}} tab1" id="historial_cargas" role="tabpanel">
                <div class="section-title">
                    <div class="right">
                        ...
                        @if(Sentinel::getUser()->hasAccess('baterias.register_in_and_out') and $data->estado='A')
            ...
            <div class="tab-pane {{$tab[1]}}" id="servicio_tecnico" role="tabpanel">
                <div class="section-title">
                    <div class="right">
                        @if(Sentinel::getUser()->hasAccess('baterias.serv_tec_store')  and $data->estado='A')
            ...
            <div class="tab-pane  {{$tab[2]}} tab3" id="historial_hidratacion" role="tabpanel">
                <div class="section-title">
                    <div class="right">
                        ...
                        @if(Sentinel::getUser()->hasAccess('baterias.register_hidratacion')  and $data->estado='A')
