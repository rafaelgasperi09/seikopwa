                ...
                <tbody>
                    ...
                    @foreach($data as $d)
                        <tr>
                            ...
                            <td>{{$d->updated_at}}</td>
                            <td>
                                <a href="{{route('maestros.equipos.edit',['id'=>$d->id,'estado'=>$d->estado])}}" class="btn btn-success btn-sm mr-1" title="Editar">
                                    <ion-icon name="pencil-outline" role="img" class="md hydrated" aria-label="pencil outline"></ion-icon>
                                </a>
                                @if(\Sentinel::hasAccess('maestros.equipos.delete') and $d->estado=='A')
                                <a href="{{route('maestros.equipos.delete',$d->id)}}" class="btn btn-danger btn-sm mr-1" title="Eliminar">
